...
function RoomCard({ img, name }) {
  ...
  return (
    <div
      className="rounded-2xl h-92 w-72 relative border-2 border-[#87d551] align-bottomp p-5 shadow-[10px_7px_12px_2px_rgba(0,0,0,0.2)] hover:-mt-5 hover:ease-in-out "
