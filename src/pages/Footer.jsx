...
function Footer() {
  ...
  return (
    <footer className="flex flex-col w-screen px-4 py-2 rounded-t-[20px] bg-[#7BC24A] text-neutral-200 Poppins md:px-10">
        ...
        <div className="flex w-[65%] justify-end text-nowrap text-sm md:text-lg">
          <div className="grid grid-cols-3 gap-16 md:gap-8">
            <div className="flex flex-col ">
              <div className="font-bold uppercase text-white text-[16px] md:pb-2">
